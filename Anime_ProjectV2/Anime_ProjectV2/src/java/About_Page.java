 ...
 * @author x12374571
 */
@WebServlet(urlPatterns = {"/About_Page"})
public class About_Page extends HttpServlet {
  ...
  /**
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String XMLFileName = path + "/main_anime.xml";
            String XSLFileName = path + "/About_Page.xsl";
