            ...
            <body style="background-color:#0F0A05">
               ...
               <!--Content starts here-->
                  ...
                  <div id="content">
                      ...
                      The Top Ten Anime's are as follows:
                      </center>
                      <center>
                      <div id="accordion" style="height:200px; width:600px;">
                            ...
                            <p>
                                ...
                                <p>
                                Genre:
                                <xsl:value-of select="//genre[@id = '1']"/>
                                </p>
                            </p>
                            </div>
                            <h3>Top 2</h3>
                            ...
                            <p>
                                ...
                                <p>
                                Genre:
                                <xsl:value-of select="//genre[@id = '2']"/>
                                </p>
                            </p>
                            </div>
                            <h3>Top 3</h3>
                            ...
                            <p>
                                ...
                                <p>
                                Genre:    
                                <xsl:value-of select="//genre[@id = '3']"/>
                                </p>
                            </p>
                            </div>
                            <h3>Section 4</h3>
                            ...
                            <p>
                                ...
                                <p>
                                 Genre:   
                                <xsl:value-of select="//genre[@id = '4']"/>
                                </p>
                            </p>
                            </div>
                            <h3>Section 5</h3>
                            ...
                            <p>
                                ...
                                <p>
                                Genre:    
                                <xsl:value-of select="//genre[@id = '5']"/>
                                </p>
                            </p>
                            </div>
                            <h3>Section 6</h3>
                            ...
                            <p>
                                ...
                                <p>
                                 Genre:   
                                <xsl:value-of select="//genre[@id = '6']"/>
                                </p>
                            </p>
                            </div>
                            <h3>Section 7</h3>
                            ...
                            <p>
                                ...
                                <p>
                                 Genre:   
                                <xsl:value-of select="//genre[@id = '7']"/>
                                </p>
                            </p>
                            </div>  
                            <h3>Section 8</h3>
                            ...
                            <p>
                                ...
                                <p>
                                 Genre:   
                                <xsl:value-of select="//genre[@id = '8']"/>
                                </p>
                            </p>
                            </div> 
                            <h3>Section 9</h3>
                            ...
                            <p>
                                ...
                                <p>
                                 Genre:   
                                <xsl:value-of select="//genre[@id = '9']"/>
                                </p>
                            </p>
                            </div> 
                            <h3>Section 10</h3>
                            ...
                            <p>
                                ...
                                <p>
                                 Genre:
                                <xsl:value-of select="//genre[@id = '10']"/>
                                </p>
                            </p>
                            </div>                                                                                                         
</div>
